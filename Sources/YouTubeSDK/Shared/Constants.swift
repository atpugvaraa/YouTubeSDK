...
public struct YouTubeSDKConstants {
    ...
    public struct OAuth {
        public static let deviceCodeURL = "https://www.youtube.com/o/oauth2/device/code"
        public static let tokenURL = "https://www.youtube.com/o/oauth2/token"
        
        // FIX: Use the official "YouTube for TV" Client ID (Cobalt)
        // This is the most stable ID available.
        public static let tvClientID = "233637204782-4kv7072124s7e83955r7923769910793.apps.googleusercontent.com"
        public static let tvClientSecret = "OUCNZ12pP7tX907293559359"
